...
ks pkg install sushildw9/nfs-server@${SU_GITHUB_VERSION}
ks pkg install sushildw9/nfs-volume@${SU_GITHUB_VERSION}
ks pkg install sushildw9/tf-${APP_NAME}job@${SU_GITHUB_VERSION}
